    ...
    <Fragment>
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-1">
                          Alfie Mason{" "}
                          <small className="text-muted">29 July 2024</small>
                        </h5>
                        <p className="mb-1">
          ...
          <div className="card active_users">
            ...
            <div className="card-body pt-0">
              <div className="list-group-flush mt-4">
                <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 fw-semi-bold border-0 border-top-0 border-bottom">
                ...
                <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 border-0 border-bottom border-0">
      ...
      <div className="row">
        <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
          <div className="card text-white bg-primary">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex text-white  justify-content-between">
      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6">
          <div className="card">
            <div className="card-body pb-0">
              <h4 className="card-title text-uppercase fw-normal">
                Market Now
              </h4>
              ...
              <div className="card overflow-hidden">
                <div className="row no-gutters">
                  <div className="col-5 p-0">
                    <div className="card-body">
                      <h6 className="fw-normal text-uppercase">
                        Weekly sales
                      </h6>
                      <h4>$ 14000</h4>
                      <div>
