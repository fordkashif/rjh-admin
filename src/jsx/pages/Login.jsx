							...
							<div className="col-xl-12 tab-content">
								<div id="sign-in" className="auth-form   form-validation">
									...
									<form onSubmit={onLogin}  className="form-validate">
										...
										<p className="text-center text-muted mb-4">Use your admin account for Royale Jazz operations.</p>
										<div className="form-group mb-3">
											<label className="mb-1"  htmlFor="val-email"><strong>Email</strong> <span className='text-danger'>*</span></label>
											<div>
