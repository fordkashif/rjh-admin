								...
								<td>
									<div className="guest-bx">
										...
										<div>
											...
											<h4 className="mb-0 mt-1"><Link  className="text-black" to={"/guest-detail"}>Deluxe A-0104</Link></h4>
										</div>
									</div>
								</td>
								<td>
							...
							<tr className="even">
								...
								<td>
									<div className="guest-bx">
										...
										<div>
											<span className="text-primary">#0012</span>
											<h4 className="mb-0 mt-1"><Link className="text-black" to={"/guest-detail"}>Deluxe B-1004</Link></h4>
										</div>
									</div>	
								</td>
								<td>
								...
								<td>
									<div className="guest-bx">
										...
										<div>
											...
											<h4 className="mb-0 mt-1"><Link className="text-black" to={"/guest-detail"}>Deluxe C-0021</Link></h4>
										</div>
									</div>	
								</td>
								<td>
