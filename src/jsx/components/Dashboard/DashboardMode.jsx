...
///Images
import pic1 from './../../../assets/images/avatar/1.jpg';
import pic2 from './../../../assets/images/avatar/2.jpg';
import pic3 from './../../../assets/images/avatar/3.jpg';
import pic4 from './../../../assets/images/avatar/4.jpg';
...
const DashboardMode = () => {
	const { changeBackground,changeNavigationHader,
		chnageSidebarColor,changeSideBarPostion,
		changePrimaryColor,changeSideBarStyle,
		changeSideBarLayout,chnageHaderColor,
						...
						<div className="col-xl-12 col-sm-6">
							<div className="card">
								...
								<div className="card-body">
									...
									<div className="progress mb-4" style={{height:"13px"}}>
										<div className="progress-bar gradient-6 progress-animated" style={{width: "55%"}}>
											<span className="sr-only">55% Complete</span>
										</div>
									</div>
									<div className="progress default-progress" style={{height:"13px"}}>
										<div className="progress-bar gradient-7 progress-animated" style={{width: "65%"}}>
							...
							<div className="row">								
								<div className="col-xl-6 col-sm-6">
									<div className="dz-image-bx rounded">
										...
										<div className="dz-info">
											<h5 className='mb-sm-2 mb-1'>Samantha Humble</h5>
											<span className="text-primary">October 3th, 2024</span>
											<div className="d-flex flex-wrap mt-1 mt-sm-2">
								...
								<div className="col-xl-6 col-sm-6">
									<div className="dz-image-bx rounded">
										...
										<div className="dz-info">
											<h5 className='mb-sm-2 mb-1'>Louise Marquee</h5>
											<span className="text-primary">October 3th, 2024</span>
											<div className="d-flex flex-wrap mt-1 mt-sm-2">
												<span className="me-auto pe-3">Room A-21</span>
												<span>3-5 Person</span>
								...
								<div className="col-xl-6 col-sm-6">
									<div className="dz-image-bx rounded">
										...
										<div className="dz-info">
											<h5 className='mb-sm-2 mb-1'>Richard Smile</h5>
											<span className="text-primary">October 3th, 2024</span>
											<div className="d-flex flex-wrap  mt-1 mt-sm-2">
												<span className="me-auto pe-3">Room A-21</span>
												<span>3-5 Person</span>
								...
								<div className="col-xl-6 col-sm-6">
									<div className="dz-image-bx rounded">
										...
										<div className="dz-info">
											<h5 className='mb-sm-2 mb-1'>Bella Yen</h5>
											<span className="text-primary">October 3th, 2024</span>
											<div className="d-flex flex-wrap  mt-1 mt-sm-2">
												<span className="me-auto pe-3">Room A-21</span>
												<span>3-5 Person</span>
