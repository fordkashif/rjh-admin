...
import pic11 from './../../../assets/images/avatar/pic11.jpg';
import pic22 from './../../../assets/images/avatar/pic22.jpg';
import pic33 from './../../../assets/images/avatar/pic33.jpg';
import pic44 from './../../../assets/images/avatar/pic44.jpg';
											...
											<div className="row align-items-center customer-review-list" key={index}>
												<div className="col-xl-3 col-lg-4 mb-xl-0 mb-3">
													<div className="review-bx">
														...
														<div>
															<span className="text-primary fs-16">{`#EMP00${125 + index}`}</span>
												...
												<div className="col-xl-3 text-end col-xxl-2 action-btn">
													<Link to={"#"} className="review-icon rounded-circle bg-success text-white me-3" ><i className="far fa-check-circle"></i></Link>
													<Link className="review-icon rounded-circle bg-danger text-white"><i className="far fa-times-circle"></i></Link>
												</div>
											</div>	
										))}
									</Tab.Pane>
											...
											<div className="row align-items-center customer-review-list" key={index}>
												<div className="col-xl-3 col-lg-4 mb-xl-0 mb-3">
													<div className="review-bx">
														<img className="me-3" src={data.image} alt="" />
														<div>
															<span className="text-primary fs-16">{`#EMP00${135 + index}`}</span>
															<h4 className="mt-1 fs-20 font-w600"><Link className="text-black" to={"/guest-detail"}>{data.title}</Link></h4>
												...
												<div className="col-xl-3 text-end col-xxl-2 action-btn">
													<Link to={"#"} className="review-icon rounded-circle bg-success text-white me-3"><i className="far fa-check-circle"></i></Link>
													<Link to={"#"} className="review-icon rounded-circle bg-danger text-white" ><i className="far fa-times-circle"></i></Link>
												</div>
											</div>	
										))}
									</Tab.Pane>
											...
											<div className="row align-items-center customer-review-list" key={index}>
												<div className="col-xl-3 col-lg-4 mb-xl-0 mb-3">
													<div className="review-bx">
														<img className="me-3" src={data.image} alt="" />
														<div>
															<span className="text-primary fs-16">{`#EMP00${145 + index}`}</span>
															<h4 className="mt-1 fs-20 font-w600"><Link className="text-black" to={"/guest-detail"}>{data.title}</Link></h4>
