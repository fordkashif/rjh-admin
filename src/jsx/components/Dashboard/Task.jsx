    ...
    return(
        <>
			...
			<div className="mb-sm-5 mb-3 d-flex flex-wrap align-items-center text-head">
				...
				<Link to={"#"} className="btn btn-secondary btn-rounded mb-2"><i className="fas fa-sync"/></Link>
			</div>          
            <div className="row">
                    ...
                    <div  className="col-xl-3 col-xxl-4 col-lg-6 col-md-6 col-sm-6" key={index}>
                        <div  className="card project-boxed">
							<div className="img-bx">
								<img src={contact.image} alt="contact" className="me-3 card-list-img w-100" width="130" />
                            </div>								  
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <div className="text-dark fs-14 text-nowrap"><i className="fa fa-calendar me-3"/>Created on Sep 8th, 2024</div>
                                </div>
                                <Dropdown className="">
