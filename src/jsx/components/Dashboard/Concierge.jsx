...
//Images
import pic1 from './../../../assets/images/avatar/pic1.jpg';
import pic2 from './../../../assets/images/avatar/pic2.jpg';
import pic3 from './../../../assets/images/avatar/pic3.jpg';
import pic4 from './../../../assets/images/avatar/pic4.jpg';
import pic5 from './../../../assets/images/avatar/pic5.jpg';
				...
				<div className="row">
					<div className="col-xl-12">
						<div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							<div className="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-4 mb-sm-2">
							...
							<Link to={"#"} className="btn btn-primary mb-xxl-0 mb-sm-0 mb-2" onClick={()=>setHandleModal(true)}><i className="far fa-file-word me-2" />Generate Report</Link>
						</div>
						<Tab.Content>
				...
				<div className="modal-content">
					...
					<div className="modal-body">
						<div className="row">
							<div className="col-xl-12">
								<div className="mb-3">
									<label htmlfor="exampleFormControlInput1" className="form-label">Job Desk</label>
							...
							<div className="col-xl-6">
								<div className="mb-3">
									<label htmlfor="exampleFormControlInput2" className="form-label">Employee Name</label>
