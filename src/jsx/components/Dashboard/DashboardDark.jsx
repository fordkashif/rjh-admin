							...
							<div className="card">
								...
								<div className="card-body">
									<div className="progress mb-4" style={{height:"13px"}}>
										<div className="progress-bar gradient-5 progress-animated" style={{width: "45%", height:"13px"}} >
									...
									<div className="progress default-progress" style={{height:"13px"}}>
										<div className="progress-bar gradient-7 progress-animated" style={{width: "65%", height:"13px"}}>
											<span className="sr-only">45% Complete</span>
										</div>
									</div>
