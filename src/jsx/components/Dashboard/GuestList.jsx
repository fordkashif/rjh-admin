...
import pic5 from './../../../assets/images/avatar/5.jpg';
import pic6 from './../../../assets/images/avatar/6.jpg';
				...
				<div className="row">
					<div className="col-xl-12">
						<div className="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							<div className="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-sm-2 mb-4">
							...
							<div className="table-search">
								<div className="input-group search-area mb-xxl-0 mb-sm-2 mb-4">
									<input type="text" className="form-control" placeholder="Search here" />
									<span className="input-group-text"><Link to={"#"}><i className="flaticon-381-search-2"></i></Link></span>
								</div>
							</div>
							<Link to={"#"} className="btn btn-primary mb-xxl-0 mb-sm-2 mb-2"
										...
										>
											<thead>
												<tr role="row">
													...
													<th className="sorting bg-none">Action</th>
												</tr>
											</thead>
											<tbody>
			...
			<Modal className="modal fade" id="exampleModal" show={report} onHide={setReport} centered>				
				<div className="modal-content">
					<div className="modal-header">
						<h1 className="modal-title fs-5">Guest Details</h1>
					...
					<div className="modal-body">
						<div className="row">
							<div className="col-xl-6">
								<div className="mb-3">
									<label htmlfor="exampleFormControlInput1" className="form-label">Guest Name</label>
							...
							<div className="col-xl-6">
								<div className="mb-3">
								<label htmlfor="exampleFormControlInput2" className="form-label">Room Type</label>
