					...
					>
						<thead>
							<tr role="row">
								...
								<th className="sorting_asc_1">Employee Name</th>
								<th className="sorting_5">Job Desk</th>
								<th className="sorting_5">Schedule</th>
								<th className="sorting_5">Contact</th>
								<th className="sorting_5">Status</th>
								<th className="sorting_5 bg-none"></th>
							</tr>
						</thead>
						<tbody>
							...
							<tr role="row" className="even">	
								...
								<td>
									<div className="concierge-bx">
										...
										<div>
											...
											<span className="fs-14">Join on May 21th, 2022</span>
										</div>
									</div>
								</td>
								<td className="job-desk">
								...
								<td>
									<div>
										<h5 className="font-w600">Monday, Tuesday, Wednesday</h5>
										<span>08:00 AM - 04:00 PM</span>
									</div>
								</td>
								<td>
