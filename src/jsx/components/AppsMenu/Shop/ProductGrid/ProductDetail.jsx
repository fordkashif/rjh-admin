                ...
                <div className="col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12">
                  <div className="product-detail-content">
                    ...
                    <div className="new-arrival-content pr">
                      <h4>Solid Women's V-neck Dark T-Shirt</h4>
						<div className="comment-review star-rating">
							<ul>
								...
								{" "}<li><i className="fa fa-star" /></li>
								{" "}<li><i className="fa fa-star" /></li>
								{" "}<li><i className="fa fa-star-half-stroke" /></li>								
							</ul>
						...
						<p>
							...
							<span className="badge badge-warning light me-1">clothes</span>
                      ...
                      {/*Quantity start*/}
						<div className="col-lg-2  col-md-4 col-sm-2 col-2 px-0">
                      ...
                      <div className="rating-stars">
                        ...
                        >	
							{[1,2,3,4,5].map((rate, index)=>(
								<li className={`me-1 star ${rate <= rating ? 'selected ' : ''}`}
